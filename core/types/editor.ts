...
export const FormFieldTypeNameMap = {
    ...
    [FieldType.web_page]: "Web page",
    [FieldType.autocomplete]: "Autocomplete",
    [FieldType.select]: "Select",
};

/**
 * Components must be grouped
 */
...
/**
 * Config for web page field
 */
export type FormWebPageFieldConfig = FormFieldConfigPrototype & {
    type: FieldType.web_page;
    exclude_ids?: number[];
};
